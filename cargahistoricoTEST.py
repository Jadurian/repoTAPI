...
import sqlalchemy
import urllib
from TAPI import capturar_fecha, ultimo_dia_CAMM, ultimo_dia_bd
...
server = 'DARCCVWSQL19'
database = 'TAPI'
tabla = 'DiarioTestAutomático'

fecha_desde = ultimo_dia_bd()
fecha_hasta = ultimo_dia_CAMM()

fecha_desde = fecha_desde+"T00:00:00.000-03:00"
fecha_hasta = fecha_hasta+"T00:00:00.000-03:00"
