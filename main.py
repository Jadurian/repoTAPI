...
def iterar_entre_fechas(fecha_desde, fecha_hasta):
    fecha_actual = datetime.strptime(fecha_desde, "%Y-%m-%dT%H:%M:%S")
    fecha_fin = datetime.strptime(fecha_hasta, "%Y-%m-%dT%H:%M:%S")
...
b = datetime.fromisoformat(str(fecha_hasta))

fecha_hasta = b + timedelta(hours=23, minutes=59)

fecha_hasta = fecha_hasta.isoformat()

print(fecha_desde, type(fecha_desde), fecha_hasta, type(fecha_hasta))

#TODO: EL FORMATO DEL DATETIME DEBE SER COMPLETO ej: 2020-11-16T00:00:00.000-03:00
